const PatentData = [
  {
    IndianPatent: [
      {
        path: "/secure-your-invention-in-india",
        heading: "Secure Your Invention in India",
        para: "We draft strong patent applications for India's Patent Office. Our experts understand Indian patent law and create applications tailored to their specific requirements.  We handle everything, from prior art searches to detailed specifications, claims, and drawings. Whether you're a startup, small business, or large corporation, we can help you efficiently  protect your intellectual property in India.",
        image: "",
      },
      {
        path: "/design-patent-application",
        heading: "Design Patent Application",
        para: "Shield your designs! Our user-friendly platform simplifies design patent applications. Get expert guidance throughout the process, from start to finish.  We protect the originality of your creations, no matter your experience level. Start safeguarding your designs today!",
        image: "",
      },
      {
        path: "/opposition-searches",
        heading: "Opposition Searches",
        para: "Opposition Searches provides comprehensive research and investigation services. Our experts use advanced methods to gather the data you need,  from background checks to competitor analysis. We deliver accurate results quickly and prioritize confidentiality throughout the process. Gain actionable insights you can trust - start your investigation today.",
        image: "",
      },
      {
        path: "/licensing-litigation-support",
        heading: "Licensing & Litigation Support",
        para: "Our Licensing & Litigation Support team tackles complex legal issues. We analyze contracts, resolve disputes, and craft strong litigation strategies.  Our experts ensure your licensing agreements are ironclad and your legal approach is effective. Focus on your business - we'll handle the legal complexities.",
        image: "",
      },
      {
  ...
  {
    PatentLitigationCommercialization: [
      {
        path: "/patent-portfolio-ranking",
        heading: "Patent Portfolio Ranking",
        para: "Our patent ranking service analyzes your patents' strength, marketability, and overall value. Make data-driven decisions for licensing, investment, and gaining a competitive edge. Maximize your intellectual property with our expert ranking",
        image: "",
      },
      {
        path: "/patent-due-diligence",
        heading: "Patent Due Diligence",
        para: "Our patent due diligence service investigates the strength, potential risks, and commercial value of patents. We provide detailed reports to help you make informed decisions on business deals, investments, and overall IP strategy. Let us safeguard your intellectual property with reliable due diligence solutions.",
        image: "",
      },
      {
        path: "/licensing-support",
        heading: "Licensing Support",
        para: "Don't get bogged down by licensing complexities!  Our experts provide guidance and support for businesses, individuals, and organizations. We handle everything from obtaining licenses to renewals and ensure compliance.  Focus on what matters - your success. Contact us today for a smoother licensing experience!",
        image: "",
      },
      {
        path: "/market-research-damage-study",
        heading: "Market Research Damage Study",
      ...
      // },
      {
        ...
        para: "Someone copying your ideas? Infringement Contentions can help! Our legal experts craft strong arguments for patent, copyright, and trademark disputes. We analyze your situation and build a watertight case to protect your intellectual property. Whether you're suing or being sued.",
        image: "",
      },
      {
        path: "/source-code-review",
        heading: "Source Code Review",
        para: "Worried about your software's code? Our expert code review service offers a deep dive into its core. We can help with patent validation (making sure your code reflects your invention), security checks, and ensuring your software runs smoothly.  Our detailed reports highlight areas for improvement and strengths, giving you the info needed to make informed decisions.  We have a proven track record in code analysis, so you can trust us to safeguard your intellectual property and optimize your software's performance.",
        image: "",
      },
    ],
  },
  ...
  },
  {
    ParalegalSupport: [
      {
        path: "/patent-trademark-docketing",
        heading: "Patent and Trademark docketing",
        para: "Never miss an IP deadline again! Our streamlined system tracks filings, renewals, and more for patents, trademarks, and copyrights. We handle the complexities so you can focus on innovation. Let us manage your IP docketing",
        image: "",
      },
      {
        path: "/india-patent-trademark-prosecution",
        heading: "India patent, Trademark filing and prosecution support",
        para: "Getting a patent or trademark in India? We can help! Our experts guide you through the process, from filing to approval, ensuring your intellectual property is protected under Indian law.",
        image: "",
      },
      {
        path: "/pta-pte-us-patents",
        heading: "PTA/PTE for US patents",
        para: "Looking to protect your intellectual property in the United States? Our team specializes in facilitating Patent Trial and Appeal Board (PTAB) proceedings and Patent Trial and Enforcement (PTE) processes. Whether you're seeking to challenge the validity of a patent or enforce your own patent rights, we provide expert guidance and representation throughout the legal journey. With our in-depth understanding of US patent law and experience navigating the complexities of PTAB and PTE, we ensure your intellectual property interests are safeguarded effectively.",
        image: "",
      },
      {
        path: "/ids-management",
      ...
      },
      {
        path: "/recordation",
        heading: "Recordation",
        para: "Our recordation service ensures your patents are officially documented with the right authorities. We handle the complexities so you can save time and focus on what matters",
        image: "",
      },
      {
        path: "/proofreading",
        heading: "Proofreading",
        para: "Want your writing to shine? Our expert proofreaders meticulously polish your documents (academic papers, reports, etc.) for grammar, punctuation, spelling, and clarity. Get professional-quality writing",
        image: "",
      },
      {
        path: "/data-verification",
        heading: "Data verification",
        para: "Keep your legal data squeaky clean with our verification service. We use advanced tech and experts to ensure accuracy and minimize risks. Get clean data, improve workflows, and boost the quality of your legal services today.",
        image: "",
      },
    ],
  }
